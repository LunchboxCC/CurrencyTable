...
namespace CurrencyTable.Services
{
    public class CurrencyDownloadServiceErste : ICurrencyDownloadService
    {
        ...
        protected string DownloadCurrencyTable()
        {
        ...
        protected List<Currency>? ParseData(string responseContent)
        {
            return JsonSerializer.Deserialize<List<Currency>>(responseContent);
        }
    }
}
